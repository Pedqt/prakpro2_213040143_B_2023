...
public class BiodataApp extends JFrame {
	 ...
	 */
	/**
	 * Variabel untuk mengidentifikasi versi serialisasi kelas.
	 */
	private static final long serialVersionUID = 1L;

	/**
	 * Metode untuk memeriksa apakah sebuah string mengandung karakter numerik.
	 * @param str String yang akan diperiksa.
	 * @return true jika string hanya berisi karakter numerik, false jika tidak.
	 */
